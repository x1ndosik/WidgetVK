...
class Binary{
	...
	public static function writeSignedShort(int $value) : string{
		return pack('s', $value);
	}
	...
	public static function writeString(string $value) : string{
		$data = pack('C', strlen($value));
		$data .= $value;
		return $data;
	}

	public static function writeSignedChar(mixed $char) : string{
		return pack('c', $char);
	}

	public static function writeUnsignedChar(mixed $char) : string{
		return pack('C', $char);
	}
